(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__1ef571a1._.js", {
...
"[project]/lib/db.js [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const db = globalThis.prisma || new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prisma$2f$client$2f$default$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["PrismaClient"]();
if ("TURBOPACK compile-time truthy", 1) globalThis.prisma = db;
}}),
"[project]/schemas/index.js [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const LoginSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].object({
    ...
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].string().min(3)
});
}}),
"[project]/models/user.js [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db.js [middleware-edge] (ecmascript)");
const runtime = "nodejs";
;
async function getUserByEmail(email) {
    try {
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["db"].user.findUnique({
            where: {
                email
            }
        });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$schemas$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/schemas/index.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$user$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/user.js [middleware-edge] (ecmascript)");
;
;
;
;
    ...
    providers: [
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"])({
            async authorize (credentials) {
                const validatedFields = __TURBOPACK__imported__module__$5b$project$5d2f$schemas$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LoginSchema"].safeParse(credentials);
                if (validatedFields.success) {
                    const { email, password } = validatedFields.data;
                    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$user$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getUserByEmail"])(email);
                    if (!user) return null;
...
;
;
const { handlers: { GET, POST }, signIn, signOut, auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])({
    // providers: [
    //   Credentials({
    //     credentials: {
    //       email: {},
    ...
    callbacks: {
        ...
        async jwt ({ token }) {
            ...
            const existingUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$user$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getUserById"])(token.sub);
    ...
    adapter: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$prisma$2d$adapter$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["PrismaAdapter"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["db"]),
    session: {
        strategy: "jwt"
    },
    ...__TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$config$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"]
});
}}),
...
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["auth"])((req)=>{
    const { nextUrl } = req;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1ef571a1._.js.map