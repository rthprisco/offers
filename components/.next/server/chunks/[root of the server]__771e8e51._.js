 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "C:\\Users\\Gabriel Dias\\Desktop\\offers-main\\generated\\prisma",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\Gabriel Dias\\Desktop\\offers-main\\prisma\\schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": "../../.env",
    ...
    "inlineSchemaHash": "861a53a010dad7a41d6b6474e83e03b0a87c11377daddd2fe97c03f750bbf260",
    "copyEngine": true
};
...
;
const db = globalThis.prisma || new __TURBOPACK__imported__module__$5b$project$5d2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]();
if ("TURBOPACK compile-time truthy", 1) globalThis.prisma = db;
}}),
"[project]/schemas/index.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const LoginSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
    ...
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().min(3)
});
}}),
...
async function getUserByEmail(email) {
    try {
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.findUnique({
            where: {
                email
            }
        });
...
var { g: global, __dirname } = __turbopack_context__;
{
/* eslint-disable import/no-anonymous-default-export */ __turbopack_context__.s({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$schemas$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/schemas/index.js [app-route] (ecmascript)");
    ...
    providers: [
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            async authorize (credentials) {
                const validatedFields = __TURBOPACK__imported__module__$5b$project$5d2f$schemas$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LoginSchema"].safeParse(credentials);
                if (validatedFields.success) {
                    const { email, password } = validatedFields.data;
                    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserByEmail"])(email);
                    if (!user) return null;
...
const { handlers: { GET, POST }, signIn, signOut, auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])({
    ...
    callbacks: {
        ...
        async jwt ({ token }) {
            ...
            const existingUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserById"])(token.sub);
    ...
    adapter: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$prisma$2d$adapter$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaAdapter"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"]),
    session: {
        strategy: "jwt"
    },
    ...__TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]
});
}}),
"[project]/app/api/auth/[...nextauth]/route.js [app-route] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/auth/[...nextauth]/route.js [app-route] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$route$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/app/api/auth/[...nextauth]/route.js [app-route] (ecmascript) <locals>");
}}),
"[project]/app/api/auth/[...nextauth]/route.js [app-route] (ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "GET": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GET"]),
    "POST": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["POST"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/auth.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$route$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/app/api/auth/[...nextauth]/route.js [app-route] (ecmascript) <locals>");
}}),
...
{
__turbopack_context__.s({
    "GET": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$route$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$exports$3e$__["GET"]),
    "POST": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$route$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$exports$3e$__["POST"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$route$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/app/api/auth/[...nextauth]/route.js [app-route] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$route$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i("[project]/app/api/auth/[...nextauth]/route.js [app-route] (ecmascript) <exports>");
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__771e8e51._.js.map